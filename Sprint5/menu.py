...
class InvestmentMenu:
    ...
    def show_graph(self, frame):
        ...
        history = self.controller.users_data[user_id]["history"]
    ...
    def balancerefresh(self):
        self.update_balance()
        self.app.after(10000, self.refresh_balance)
    ...
    def menuGui(self):
        ...
        self.username_label = customtkinter.CTkLabel(self.left_frame, text="Username: ", font=("Banschrift", 16))
